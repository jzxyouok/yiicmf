...
```
php composer.phar require --prefer-dist yii2/yii2-widget-highcharts "dev-master"
```

or add

```
"yii2/yii2-widget-highcharts": "dev-master"
```
...
```php
use yii\widget\highcharts\Highcharts;
...
```php
use yii\widget\highcharts\HighchartsAsset;
...
* All adapters, modules, themes, and supplementary chart types must be enabled through the top-level 'scripts' option.
  ...
  ...
  ```
  For a list of available scripts, see the contents of `vendor/yiisoft/yii2-widget-highcharts/assets/`.