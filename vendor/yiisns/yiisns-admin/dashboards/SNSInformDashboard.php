 ...
 * @package yiisns\admin\dashboards\base
 */
class SNSInformDashboard extends AdminDashboardWidgetRenderable
{
    static public function descriptorConfig()
    {
        return array_merge(parent::descriptorConfig(), [
            'name' => \Yii::t('yiisns/kernel', 'Short Information')
        ]);
    }

    public $viewFile = 'yiisns-inform';
    ...
    public function init()
    {
        ...
        if (!$this->name)
        {
            $this->name = \Yii::t('yiisns/kernel', 'Short Information');
        }
    }
