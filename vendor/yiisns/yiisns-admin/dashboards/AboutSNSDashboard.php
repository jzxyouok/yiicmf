...
/**
 * Class AboutSNSDashboard
 * @package yiisns\admin\dashboards
 */
class AboutSNSDashboard extends AdminDashboardWidgetRenderable
{
    static public function descriptorConfig()
    {
        return array_merge(parent::descriptorConfig(), [
            'name' => \Yii::t('yiisns/kernel', 'Information about YiiSNS')
        ]);
    }

    public $viewFile = 'about-yiisns';
    ...
    public function init()
    {
        ...
        if (!$this->name)
        {
            $this->name = \Yii::t('yiisns/kernel', 'Information about YiiSNS');
        }
    }
