 ...
 */
class AdminTreeTypePropertyController extends AdminModelEditorController
{
    public $notSubmitParam = 'sx-not-submit';

    public function init()
    {
        $this->name                   = \Yii::t('yiisns/kernel', 'Manage Section Properties');
        $this->modelShowAttribute      = 'name';
        $this->modelClassName          = TreeTypeProperty::className();
