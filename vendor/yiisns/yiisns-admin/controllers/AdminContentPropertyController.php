...
/**
 * Class AdminContentPropertyController
 * @package yiisns\admin\controllers
 */
class AdminContentPropertyController extends AdminModelEditorController
{
    public $notSubmitParam = 'sx-not-submit';

    public function init()
    {
        $this->name                   = \Yii::t('yiisns/kernel', 'Property Management');
        $this->modelShowAttribute      = 'name';
        $this->modelClassName          = ContentProperty::className();
