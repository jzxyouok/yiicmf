                ...
                <div class="panel-content">
                    <div class="sx-act sx-act-login">
                        <?php $form = ActiveForm::begin([
                            ...
                            <?= $form->field($loginModel, 'identifier')->textInput(['placeholder' => $loginModel->getAttributeLabel('identifier')])->label(false); ?>
                            <?= $form->field($loginModel, 'password')->passwordInput(['placeholder' => $loginModel->getAttributeLabel('password')])->label(false); ?>
                                ...
                                <div>
                                    ...
                                    <div style="color:#999;margin:1em 0">
                                        <a href="#" class="sx-act-controll" onclick="sx.auth.goActForget(); return false;"><?= \Yii::t('yiisns/kernel', 'Recover password')?></a>
                                    </div>
                                </div>
                        <?php ActiveForm::end(); ?>
                    </div>
                    <div class="sx-act sx-act-forget">
                        <?php $form = ActiveForm::begin([
                            ...
                            <div class="sx-form-messages"></div>
                            <?= $form->field($passwordResetModel, 'identifier')->textInput(['placeholder' => $loginModel->getAttributeLabel('identifier')])->label(false); ?>
                                <?= Html::input('hidden', 'do', 'password-reset'); ?>
                                <div class="form-group sx-submit-group">
                                    <?= Html::submitButton("<i class='glyphicon glyphicon-off'></i> " . \Yii::t('yiisns/kernel', 'Recover password'), [
                                ...
                                <div class="sx-hidden1">
                                    <hr />
                                    <div style="color:#999;margin:1em 0">
                                        <?= \Yii::t('yiisns/kernel', 'I remembered password')?> <a href="#" class="sx-act-controll" onclick="sx.auth.goActLogin(); return false;"><?= \Yii::t('yiisns/kernel','log in') ?></a>
                                    </div>
                                </div>
                        <?php ActiveForm::end(); ?>
                    </div>
