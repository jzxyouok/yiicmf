...
/* @var $widget \yiisns\admin\widgets\formInputs\OneImage */
?>
    ...
    <div class="col-lg-12">
        <div class="row">
            ...
            <div class="sx-one-btn col-lg-2 col-md-2 col-sm-2">
                <a class="btn btn-default sx-btn-create-file-manager"><i class="glyphicon glyphicon-download-alt"></i> <?=\Yii::t('yiisns/kernel','Choose file')?></a>
            </div>
