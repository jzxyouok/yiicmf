...
use yiisns\admin\assets\AdminGridAsset;
...
JS
        ...
        return "<div class='sx-per-page'><form method='get' action='" . $url . "'> <span class='per-page-label'>".\Yii::t('yiisns/kernel', 'On the page').":</span>"
