(function(sx, $, _)
{
    ...
    sx.classes.grid.MultiAction = sx.classes.grid._Action.extend({
        ...
        execute: function()
        {
            ...
            {
                sx.notify.info("You must select at least one item.");
                return this;
            }
    ...
    sx.classes.grid.CheckFullAll = sx.classes.grid._Element.extend({
        ...
        _onDomReady: function()
        {
            ...
            this.JQueryCheckbox.on('change', function()
            {
                ...
                {
                    sx.confirm('are you sure you want to apply to all the records in the list, including other pages list, not only for the flags?', {
                        'no': function(e, data)
                        {
