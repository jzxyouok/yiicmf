...
$adminFilter = new \yiisns\kernel\models\AdminFilter();
...
<? $createModal = \yii\bootstrap\Modal::begin([
    ...
    'header'    => '<b>' . \Yii::t('yiisns/admin', 'Create filter') . '</b>',
    'footer'    => '
        <button class="btn btn-primary" onclick="$(\'#' . $createFormId . '\').submit(); return false;">' . \Yii::t('yiisns/kernel', 'Create') . '</button>
