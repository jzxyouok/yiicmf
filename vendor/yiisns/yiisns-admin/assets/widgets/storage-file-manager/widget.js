        ...
        _onWindowReady: function()
        {
            ...
            var uploader = new ss.SimpleUpload(_.extend(this.get("options"), {
                ...
                onExtError: function(filename, extension)
                {
                    ...
                    self.trigger("error", filename + " File type not allowed for download");
                },
                onSizeError: function(filename, fileSize)
                {
                    self.trigger("error", filename + " Too large, allowed no more than " + Number(self.get("options").maxSize) + " Kb");
                },
                ...
                onComplete: function(filename, response)
                {
                    if (!response)
                    {
                        self.trigger("error", "Failed to load file");
                    }
