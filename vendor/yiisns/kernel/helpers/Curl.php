 ...
 */
namespace yiisns\kernel\helpers;
...
/**
 *
 * @property array $options Class Curl
...
class Curl extends Component
{
    ...
    public function init()
    {
        if (! function_exists('curl_init')) {
            throw new \InvalidArgumentException('PHP-Curl Library not installed');
        }
    }
    ...
    private $_defaultOptions = [
        CURLOPT_USERAGENT => 'YiiSNS-Curl-Agent',
        CURLOPT_TIMEOUT => 30,
