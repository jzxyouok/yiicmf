...
class ContentElementSearch extends ContentElement
{
    ...
    public function attributeLabels()
    {
        return ArrayHelper::merge(parent::attributeLabels(), [
            'section' => \Yii::t('yiisns/kernel', 'Section'),
            ...
            'published_at_from' => \Yii::t('yiisns/kernel', 'Time of publication (from)'),
            'published_at_to' => \Yii::t('yiisns/kernel', 'Time of publication (up to)'),

            'has_image' => \Yii::t('yiisns/kernel', 'Image'),
            'has_full_image' => \Yii::t('yiisns/kernel', 'The presence of such images'),
    ...
    public function search($params)
    {
        ...
        if ($this->section)
        {
            ...
            $query->andFilterWhere([
                ...
                [ContentElementTree::tableName() . '.tree_id' => $this->section]
            ]);
        }
