...
class PasswordChangeForm extends Model
{
    ...
    {
        return [
            'new_password' => \Yii::t('yiisns/kernel', 'New Password'),
            'new_password_confirm' => \Yii::t('yiisns/kernel', 'New Password Confirm')
        ];
    }
    ...
    public function validateNewPassword($attribute, $params)
    {
        if ($this->new_password_confirm != $this->new_password) {
            $this->addError($attribute, \Yii::t('yiisns/kernel', 'New passwords do not match'));
        }
    }
