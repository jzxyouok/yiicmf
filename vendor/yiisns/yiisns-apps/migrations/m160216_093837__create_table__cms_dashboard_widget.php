...
class m160216_093837__create_table__cms_dashboard_widget extends Migration
{
    public function safeUp()
    {
        ...
        $this->createTable("{{%cms_dashboard_widget}}", [
            ...
            'dashboard_column'  => $this->integer()->notNull()->defaultValue(1),
        ...
        $this->createIndex('priority', '{{%dashboard_widget}}', 'priority');
        $this->createIndex('component', '{{%dashboard_widget}}', 'component');
        $this->createIndex('dashboard_id', '{{%dashboard_widget}}', 'cms_dashboard_id');
        $this->createIndex('dashboard_column', '{{%dashboard_widget}}', 'dashboard_column');
