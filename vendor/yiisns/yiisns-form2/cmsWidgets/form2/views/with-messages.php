...
;
    ...
    $form = \yiisns\form2\widgets\ActiveFormConstructForm::begin([
...
<? if ($properties = $modelHasRelatedProperties->relatedProperties) : ?>
    ...
    <? endforeach; ?>
<? endif; ?>
<?= \yii\helpers\Html::tag($widget->btn_tag, \Yii::t('yiisns/form2', $widget->btnSubmit), $widget->btn_options); ?>
<?php \yiisns\form2\widgets\ActiveFormConstructForm::end(); ?>