...
// Else send to user html application of console.
...
$result = \Yii::$app->console->execute('cd '  . ROOT_DIR . '; php yii apps/utils/all-cmd');
$possibleCmd = explode("\n", $result);

$autocomplete = [
    '^\w*$' => array('cd', 'ls', 'mkdir', 'chmod', 'git', 'hg', 'diff', 'rm', 'mv', 'cp', 'more', 'grep', 'ff', 'whoami', 'kill', 'php', 'yii', 'composer', 'apps/update', 'apps/composer/status'),
...
\yiisns\sshConsole\assets\AdminSshConsoleAsset::register($this);
