    ...
    <div class="col-sm-8 news-v3">
        <div class="news-v3-in-sm no-padding">
            ...
            <ul class="list-inline posted-info">
                <? if ($model->createdBy) : ?>
                    <li>Added: <a href="<?= $model->createdBy->getPageUrl(); ?>" title="<?= $model->createdBy->name; ?>"><?= $model->createdBy->name; ?></a></li>
                <? endif; ?>
                <? if ($model->cmsTree) : ?>
                    <li>Category: <a href="<?= $model->tree->url; ?>" title="<?= $model->tree->name; ?>"><?= $model->tree->name; ?></a></li>
                <? endif; ?>
                <li>The time of publication: <?= \Yii::$app->formatter->asDate($model->published_at, 'full')?></li>
            ...
            <p><a href="<?= $model->url; ?>">Read more</a></p>
